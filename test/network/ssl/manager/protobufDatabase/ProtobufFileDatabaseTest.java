...
class ProtobufFileDatabaseTest {
	...
	void generateUniqueId_addItemsAndCheckIdValues() throws Exception {
		...
		ClientProfile profile1 = ClientIdentities.newClientProfile(	1, 
																	"Rozach", 
																	ClientStatus.ONLINE, 
																	images, 
																	badges, 
		...
		ClientProfile profile2 = ClientIdentities.newClientProfile(	2, 
																	"Jenn", 
																	ClientStatus.ONLINE, 
																	images, 
																	badges, 
		...
		ClientProfile profile3 = ClientIdentities.newClientProfile(	3, 
																	"Husan", 
																	ClientStatus.ONLINE, 
																	images, 
																	badges, 
		...
		ClientProfile profile4 = ClientIdentities.newClientProfile(	4, 
																	"Hendrizio", 
																	ClientStatus.ONLINE, 
																	images, 
																	badges, 
		...
		ClientProfile profile5 = ClientIdentities.newClientProfile(	5, 
																	"Farkan", 
																	ClientStatus.ONLINE, 
																	images, 
																	badges, 
