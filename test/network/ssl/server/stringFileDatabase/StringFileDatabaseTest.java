...
class StringFileDatabaseTest {
	...
	void initialize_itemListContainsAllStrings() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testInit.txt");
	...
	void readItem_readsCorrectItems() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testRead.txt");
		database.initialize();
	...
	void clear_databaseIsEmpty() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testClear.txt");
		database.initialize();
	...
	void seekTo_moveFilePointerToGivenIndexes() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testSeek.txt");
	...
	void addItem_insertItems_checkFileContentAndOrder() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testAddItems.txt");
	...
	void removeItem_deleteSingleItem_indexArgument() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testRemoveSingleItemIndex.txt");
	...
	void removeItem_deleteMultipleItems_indexArgument() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testRemoveMultipleItemsIndexes.txt");
	...
	void removeItem_deleteSingleItem_objectArgument() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testRemoveSingleItemObject.txt");
	...
	void removeItem_deleteMultipleItems_objectArgument() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testRemoveMultipleItemsObjects.txt");
	...
	void removeItem_deleteAllItems_databaseIsEmpty() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testRemoveAllItems.txt");
		database.clear();
	...
	void replaceItem_test() throws IOException {
		database = new StringFileDatabase("test/testresources/stringFileDatabase/testReplaceItems.txt");
