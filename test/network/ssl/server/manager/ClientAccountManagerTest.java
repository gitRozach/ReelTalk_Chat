...
class ClientAccountManagerTest {
	...
	@Test
	void fillItems_temp() throws IOException {
//		database = new ClientAccountDatabase();
//		database.loadFileItems("src/clientData/accounts.txt");
//		
//		for(int i = 0; i < 20; ++i) {
...
//			
//			ClientProfile profile2 = ClientIdentities.newClientProfile(	database.generateUniqueBaseId(), 
//																		"Client" + (i+2), 
//																		ClientStatus.ONLINE, 
//																		images, 
//																		badges, 
...
//			
//			ClientProfile profile3 = ClientIdentities.newClientProfile(	database.generateUniqueBaseId(), 
//																		"Client" + (i+3), 
//																		ClientStatus.ONLINE, 
//																		images, 
//																		badges, 
...
//			
//			ClientProfile profile4 = ClientIdentities.newClientProfile(	database.generateUniqueBaseId(), 
//																		"Client" + (i+4), 
//																		ClientStatus.ONLINE, 
//																		images, 
//																		badges, 
