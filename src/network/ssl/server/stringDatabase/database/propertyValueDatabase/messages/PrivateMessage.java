package network.ssl.server.stringDatabase.database.propertyValueDatabase.messages;
...
public class PrivateMessage extends Message {
	...
	public String toDatabaseString() {
		return 	super.toDatabaseString() + RECEIVER_ID_PROPERTY_NAME + PROPERTY_START + getReceiverId() + PROPERTY_END;
	}
