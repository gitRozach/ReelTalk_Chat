...
public class FXUtils {
	...
	public static Node createHorizontalSpacer(double width) {
		...
		FXUtils.setFixedWidthOf(spacer, width);
		return spacer;
	}
	...
	public static Font Font(double fontSize) {
		return Font(fontSize, null, FontPosture.REGULAR);
	}

	public static Font Font(double fontSize, FontWeight fontWeight) {
		return Font(fontSize, fontWeight, FontPosture.REGULAR);
	}

	private static Font Font(double fontSize, FontWeight fontWeight, FontPosture fontPosture) {
		return Font.font("Tahoma", fontWeight, fontPosture, fontSize);
	}
}
